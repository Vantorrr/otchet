...
class YandexGPTService:
    ...
    async def generate_manager_comment(
        ...
        prompt = (
            ...
            "Прошлый период:\n" + "\n".join(prev_lines) + "\n\n"
            "Текущий период:\n" + "\n".join(cur_lines) + "\n\n"
            "Дай комментарий (60-90 слов):\n"
            "1. Что изменилось vs прошлый период\n"
            "2. Где отстаёт или лидирует\n"  
    ...
    async def generate_team_comment(self, totals: Dict[str, Any], period_name: str) -> str:
        ...
        prompt = (
            f"Комментарий по команде за {period_name} (60-90 слов):\n"
            "Проанализируй данные и выдели три главных пункта:\n"
            "1. Общие итоги\n"
            "2. Узкие места\n"
            "3. Приоритеты на неделю\n\n"
    ...
    async def generate_comparison_comment(self, prev: Dict[str, Any], cur: Dict[str, Any], title: str) -> str:
        ...
        prompt = (
            f"Сравнение: {title} (60-90 слов)\n\n"
            "Проанализируй динамику между периодами. Выдели три пункта:\n"
            "1. Где улучшения/ухудшения\n"
            "2. Причины изменений\n"
            "3. Что делать дальше\n\n"
            f"Заголовок: {title}.\n\n"
